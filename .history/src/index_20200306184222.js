...
class MovieItem extends React.Component{
    ...
    toogleOverview = () => this.setState({!this.state.show})
    ...
    render(){
        ...
        <p className={'vote'}>{vote}</p>
        <Image src={image} alt={tittle}/>
        <button type="button" onClick={this.toogleOverview}>Show overview</button>
        ...
        {/* {this.state.show === true ? <p className={'overview'}>{overview}</p> : null }
        <button type='button' onClick={this.toggleOverview}>{this.state.show? 'Hide overview' : 'Show overview'}</button> */}
