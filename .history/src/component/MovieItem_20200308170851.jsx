...
const MovieItem = (props) => {
    ...
    return  <div key={props.movie.id} className={'movie__item'}>
    ...
    <button className={'movie__btn'} onClick={props.removeMovie.bind(props, props.movie)} type='button'>Delete movie</button>
  </div> 
}
