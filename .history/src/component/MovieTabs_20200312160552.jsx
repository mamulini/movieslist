        ...
        return(
            <ul className={'movie__tabs nav nav__pils'}>
                <li className={'nav__item'}>
                    <div className={`nav__link ${sortBy === 'popularity.desc' ? 'active' : ''}`} onClick={updateSortBy('popularity.desc')}>Popularity desc</div>
                </li>
                <li className={'nav__item'}>
                    <div className={`nav__link ${sortBy === 'revenue.desc' ? 'active' : ''}`}
                    onClick={updateSorty('revenue.desc')}>Revenue desc</div>
                </li>
                <li className={'nav__item'}>
