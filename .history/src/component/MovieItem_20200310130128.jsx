  ...
  render() {
    ...
    return( 
           <div key={movie.id} className={'movie__item'}>
             ...
             {this.state.willWatch ? <button className={'willWatch__btn--succes'} onClick={addMoviesToWillWatch.bind(null, movie)} type='button'>Will Watch</button>}
             <button className={'willWatch__btn'} onClick={addMoviesToWillWatch.bind(null, movie)} type='button'>Will Watch</button>
