  ...
  render() {
    ...
    return( 
          <div key={movie.id} className={'movie__item'}>
             ...
             ? 
            (<button type='button' className={'willWatch__btn--succes'} onClick={addMoviesToWillWatch.bind(null, movie)} >Remove Will Watch</button> )
             : 
             (<button className={'willWatch__btn'} onClick={() => {
              this.setState({willWatch: true})}; 
              addMoviesToWillWatch.bind(null, movie)} type='button'>Add Will Watch</button>)
             }
