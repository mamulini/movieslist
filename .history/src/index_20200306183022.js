...
class MovieItem extends React.Component{
    ...
    render(){
        ...
        <button type='button' onClick={() => this.setState({ show: true}) }>{this.state.show? 'Hide overview' : 'Show overview' this.setState({show:true})}</button>
        {/* <button type='button' onClick={() => this.setState({ show: false})}>Hide overview</button> */}
     </div>
        )
    }
}
