  ...
  render(){
    console.log('render');
      ...
      <div className='container'>
        <MovieTabs sortBy={this.state.sortBy} />
        <div className={'movie__wrapper'}>
          <div className={'movies'}>{this.state.movies.map( movie => {
          return(
           <MovieItem removeMovie={this.removeMovie} addMoviesToWillWatch={this.addMoviesToWillWatch}  movie={movie} removeMovieFromWillWatch={this.removeMovieFromWillWatch} updateSortBy={this.updateSortBy} />
          )
          })}
